...
public class HoodieTableMetaClient implements Serializable {
  ...
  public static String AUXILIARYFOLDER_NAME = METAFOLDER_NAME + File.separator + ".extra";
  ...
  public static List<HoodieInstant> scanHoodieInstantsFromFileSystem(
      FileSystem fs, Path metaPath, String[] includedExtensions) throws IOException {
