...
public class HoodieFileGroupBuilder implements Builder<HoodieFileGroup> {
  ...
  public HoodieFileGroupBuilder(String partitionPath, String id, HoodieTimeline timeline) {
  ...
  public HoodieFileGroupBuilder withDataFile(HoodieDataFile dataFile) {
    // skip the data file if it is not from a committed instant. Concurrent
    ...
    if (timeline.containsOrBeforeTimelineStarts(dataFile.getCommitTime())) {
